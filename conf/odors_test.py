...
probe1_params = {'reward_probe': [1], 'delivery_probe': [[1, 2]], 'odor_idx': [[1, 2]], 'duration': [[1501, 1502]],
                 'dutycycle': [[100, 0], [90, 10], [80, 20], [70, 30], [60, 40], [50, 50]]}
probe2_params = {'reward_probe': [2], 'delivery_probe': [[2, 1]], 'odor_idx': [[2, 1]], 'duration': [[1502, 1501]],
                 'dutycycle': [[100, 0], [90, 10], [80, 20], [70, 30], [60, 40], [50, 50]]}
